...
const HERSHEY = {
  ...
  'Q': [17, [[7,21],[4,20],[2,18],[1,16],[0,13],[0,8],[1,5],[2,3],[4,1],[7,0],[10,0],[13,1],[15,3],[16,5],[17,8],[17,13],[16,16],[15,18],[13,20],[10,21],[7,21]].reduce((a,p,i,arr)=>i>0?[...a,[arr[i-1][0],arr[i-1][1],p[0],p[1]]]:a,[]), [11,6,17,0]]],
